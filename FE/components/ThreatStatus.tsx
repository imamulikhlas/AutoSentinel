  ...
  return (
    <div className="text-center">
      <div className="inline-flex flex-col items-center bg-gray-800/50 backdrop-blur-xl rounded-2xl sm:rounded-3xl p-8 sm:p-12 border-gray-700/50 shadow-2xl hover:shadow-blue-500/10 transition-all duration-500 relative overflow-hidden max-w-4xl mx-auto">
        ...
        <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-4 sm:mb-6 relative z-10 px-4">
          {getUserRiskLevel(auditData.risk_level)}
        </h2>

        <div
          className={`inline-flex px-6 sm:px-8 py-3 sm:py-4 rounded-full font-bold text-lg sm:text-xl border-2 bg-gradient-to-r ${getRiskColor(auditData.risk_level)} text-white shadow-2xl border-white/20 relative z-10 animate-pulse-glow`}
        >
